...
* [B:](http://asn.desire2learn.com/resources/S2696092) Architecture of Linked Data applications
    * [C:] Knows the tiered software architecture of data, logic, and presentations tiers.
    * [C:] Understands that the presentation tier is for visualization and presentation of data.
    * [C:] Understands that the logic tier is for sophisticated processing of data.
    * [C:] Understands that the data tier is for data access and preparation.
    * [C:] Knows that in the data tier, wrappers are used to create a unified data access component for different types of data (e.g., Linked Data, relational data, XML data).
    * [C:] Knows that in the data tier, the access component feeds into a data integration component that interlinks, maps, and cleans the data.
    * [C:] Knows that in the data tier, the preprocessed and cleaned data is typically stored in an integrated data store.
    * [C:] Knows and can differentiate the different data access patterns: crawling with caching, uncached on-the-fly, and federated query.
